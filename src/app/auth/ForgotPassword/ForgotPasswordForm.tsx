...
import forgotPassword from "@/app/services/auth/forgotPassword.api";
export default function ForgetPasswordForm() {
  ...
  const handleForgotPassword = async (values: ForgetPasswordType) => {
    await forgotPassword(values, router);
  };
  ...
  return (
    <>
      <div className="w-1/2 mx-auto mt-7 space-y-7">
        ...
        <form
          onSubmit={myForm.handleSubmit(handleForgotPassword)}
          className="space-y-5"
        >
          <Controller
            name="email"
