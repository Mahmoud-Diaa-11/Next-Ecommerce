...
import signUp from "@/app/services/auth/signup.api";
...
export default function RegisterForm() {
  ...
  const handleSignUp = async (values: RegisterType) => {
  ...
  return (
    <>
      <div className="w-1/2 mx-auto mt-7 space-y-7">
        <h2 className="font-semibold text-3xl text-green-600">Register Now:</h2>
        <form
          onSubmit={myForm.handleSubmit(handleSignUp)}
          className="space-y-5"
        >
          <Controller
            name="name"
